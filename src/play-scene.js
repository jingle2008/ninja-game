...
export class PlayScene extends Phaser.Scene {
    ...
    addGameTitle() {
        ...
        blackOverlay.displayWidth = this.game.config.width;
        blackOverlay.displayHeight = this.game.config.height;
        ...
        // add the title
        let title = this.add.sprite(this.game.config.width / 2, 50, 'title');
        ...
        // add play button
        let playButtonX = this.game.config.width / 2;
        let playButtonY = this.game.config.height / 2 - 20;
        ...
        // add the sound icon
        let soundButton = this.add.sprite(
            playButtonX,
            playButtonY + 300,
            'icons'
        );
    ...
    addPole() {
        ...
        this.pole = this.add.sprite(
            bounds.right - gameOptions.poleWidth,
            bounds.top,
            'tile'
        );
    ...
    showGameScore() {
        ...
        this.scoreText = this.add.bitmapText(
            ...
            energyBounds.top - 40,
            'font',
            'DISTANCE: ' + this.mountains.toString()
        );
        ...
        this.bestScoreText = this.add.bitmapText(
            ...
            'font',
            'MAX DISTANCE: ' + this.bestScore.toString()
        );
    ...
    updateTimer() {
        ...
        this.energyStatus.displayWidth =
            (500 * this.timeLeft) / gameOptions.initialTime;
        ...
        if (this.gameMode == WAITING_FOR_INPUT_STOP) {
            ...
            this.tweens.add({
                ...
                onComplete: function () {
                    ...
                    if (
                        poleBounds.right >= dangerBounds.left &&
                        poleBounds.right <= dangerBounds.right
                    ) {
                    ...
                    let platformBounds = this.platforms[
                        1 - this.mainPlatform
                    ].getBounds();
    ...
    prepareNextMove() {
        ...
        this.pole.alpha = 1;
        this.pole.x =
            this.platforms[this.mainPlatform].getBounds().right -
    ...
    fallAndDie() {
        ...
        this.tweens.add({
            ...
            y: this.game.config.height + this.hero.displayHeight * 2,
    ...
    showGameOver() {
        ...
        let restartIcon = this.add.sprite(
            halfGameWidth - 120,
    ...
    addDangerZone() {
        ...
        this.dangerZone = this.add.sprite(
            0,
            this.platforms[this.mainPlatform].y,
            'dangertile'
        );
    ...
    addPlatforms() {
        ...
        this.platforms = [
            this.addPlatform(
                (this.game.config.width - gameOptions.defaultSize.width) / 2
            ),
            this.addPlatform(this.game.config.width),
        ];
    ...
    addPlatform(posX) {
        ...
        let platform = this.add.sprite(
            posX,
            this.game.config.height * gameOptions.platformHeight,
            'tile'
        );
        ...
        platform.displayHeight =
            this.game.config.height * (1 - gameOptions.platformHeight) + 50;
    ...
    addClouds() {
        ...
        let clouds = Math.ceil(this.game.config.width / 128);
